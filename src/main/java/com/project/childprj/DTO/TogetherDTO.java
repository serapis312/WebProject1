...
public class TogetherDTO {
   ...
   public static List<TogetherDTO> fromJson(String jsonData) throws IOException {
      ...
      for (JsonNode row : rows) {
         ...
         togetherDTO.setPlayer(row.get("PLAYER").asText());
         togetherDTO.setProgram(row.get("PROGRAM").asText());
         togetherDTO.setEtc_desc(row.get("ETC_DESC").asText());
         togetherDTO.setOrg_link(row.get("ORG_LINK").asText());
         togetherDTO.setMain_img(row.get("MAIN_IMG").asText());
         togetherDTO.setRgstdate(row.get("RGSTDATE").asText());
         togetherDTO.setTicket(row.get("TICKET").asText());
